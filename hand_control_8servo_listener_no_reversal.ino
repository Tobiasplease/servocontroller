/*
 * 8-Servo Hand Control Listener (ACTIVE) - NO REVERSAL
 ...
 * Range clamped to 0-180 degrees. NO REVERSAL APPLIED.
 */
...
void setup() {
  ...
  delay(1000);
  Serial.println("8-Servo Hand Control Ready - Listening for HAND8 commands (NO REVERSAL)");
